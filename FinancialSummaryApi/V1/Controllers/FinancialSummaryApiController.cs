...
namespace FinancialSummaryApi.V1.Controllers
{
    ...
    public class FinancialSummaryApiController : BaseController
    {
        private readonly IGetAllUseCase _getAllUseCase;
        private readonly IGetByIdUseCase _getByIdUseCase;
        public FinancialSummaryApiController(IGetAllUseCase getAllUseCase, IGetByIdUseCase getByIdUseCase)
        {
